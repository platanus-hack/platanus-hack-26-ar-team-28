...
export const MobileMenu = ({ className }: MobileMenuProps) => {
  ...
  const menuItems = [
    ...
    { name: "Por Que Ahora", href: "#por-que-ahora" },
    { name: "Docs", href: "#docs" },
  ];
          ...
          <nav className="flex flex-col space-y-6 container mx-auto">
            ...
            <div className="mt-6 flex flex-col gap-3">
              <Link
                href="/login"
                onClick={handleLinkClick}
                className="inline-block text-xl font-mono uppercase text-foreground/80 transition-colors ease-out duration-150 hover:text-foreground py-2"
              >
                Iniciar sesión
              </Link>
              <Link
